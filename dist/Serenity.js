...
(()=>{var T=`@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap');
...
`;var _={name:"ClickGUI",category:"Visual",description:"The main user interface for the client.",enabled:!0,element:null,overlay:null,activeCategory:"Visual",activeSettingsModule:null,isEditingHUD:!1,activeHUDSettingsPopup:null,searchQuery:"",isGuiOpen:!1,isCleaningUp:!1,activeConfigTab:"Themes",activeView:"modules",onEnable(e){if(!(this.isCleaningUp||this.element)){if(this.isGuiOpen=!0,document.body.classList.add("serenity-no-scroll"),document.pointerLockElement&&document.exitPointerLock(),!document.getElementById("font-awesome-link")){let t=document.createElement("link");t.id="font-awesome-link",t.rel="stylesheet",t.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css",document.head.appendChild(t)}this.createGUI(e),setTimeout(()=>{this.overlay&&this.overlay.classList.add("visible"),this.element&&this.element.classList.add("visible")},50)}},onDisable(e){this.isGuiOpen=!1,this.exitHUDeditor(e),document.body.classList.remove("serenity-no-scroll");let t=document.getElementById("noa-canvas");t&&!document.pointerLockElement&&(t.requestPointerLock(),t.click()),this.cleanup()},cleanup(){this.overlay&&!this.isCleaningUp&&(this.isCleaningUp=!0,this.overlay.classList.remove("visible"),this.element.classList.remove("visible"),setTimeout(()=>{this.overlay&&document.body.removeChild(this.overlay),this.element&&document.body.removeChild(this.element),this.overlay=null,this.element=null,this.isCleaningUp=!1,document.body.classList.remove("serenity-no-scroll");let e=document.getElementById("font-awesome-link");e&&document.head.removeChild(e)},300))},createGUI(e){this.overlay=document.createElement("div"),this.overlay.className="serenity-overlay",document.body.appendChild(this.overlay),this.element=document.createElement("div"),this.element.className="serenity-container";let t=this.createSidebar(e);this.element.appendChild(t);let i=this.createContent(e);this.element.appendChild(i),document.body.appendChild(this.element)},createSidebar(e){let t=document.createElement("div");t.className="serenity-sidebar";let i=document.createElement("div");i.className="serenity-logo",i.innerHTML=`
    ...
    `,this.container.prepend(r),r.style.animation="serenity-notification-in 0.5s forwards cubic-bezier(0.2, 1, 0.2, 1)";let a=r.querySelector(".serenity-notification-timer");a.style.transition=`width ${o}ms linear`,setTimeout(()=>{a&&(a.style.width="0%")},10);let c=()=>{r.classList.contains("exiting")||(r.classList.add("exiting"),clearTimeout(d),r.style.animation="serenity-notification-out 0.5s forwards cubic-bezier(0.8, 0, 0.8, 0)",r.addEventListener("animationend",p=>{p.animationName==="serenity-notification-out"&&r.remove()}))};r.querySelector(".serenity-notification-close").addEventListener("click",c,{once:!0});let d=setTimeout(c,o);r.addEventListener("mouseenter",()=>{clearTimeout(d),a.style.width=getComputedStyle(a).width}),r.addEventListener("mouseleave",()=>{d=setTimeout(c,o),a.style.transition=`width ${o}ms linear`,a.style.width="0%"})}},V=z;var ae={name:"Notifications",category:"Utility",description:"Shows alerts when modules are toggled.",enabled:!1,settings:[]},W=ae;var le={_ctx:null,getContext:function(){return this._ctx||(this._ctx=document.createElement("canvas").getContext("2d")),this._ctx}},de={name:"ArrayList",category:"Visual",description:"Displays a list of enabled modules.",enabled:!1,element:null,settings:[{id:"color-mode",name:"Color Mode",description:"The color style of the module list.",type:"select",options:["Rainbow","Static"],value:"Static"},{id:"use-theme-color",name:"Use Theme Color",description:"Use the main theme color for static mode.",type:"boolean",value:!0,condition:e=>e["color-mode"]==="Static"},{id:"static-color",name:"Custom Static Color",description:"The color of the text if not using the theme color.",type:"color",value:"rgba(94, 114, 235, 1)",condition:e=>e["color-mode"]==="Static"&&!e["use-theme-color"]},{id:"border",name:"Show Border",description:"Display a colored border on the side of the list.",type:"boolean",value:!0},{id:"text-shadow",name:"Text Shadow",description:"Adds a shadow to the text for better visibility.",type:"boolean",value:!0},{id:"font-size",name:"Font Size",description:"The font size of the module names.",type:"slider",min:10,max:20,step:1,value:14}],onEnable(e){this.element||(this.element=document.createElement("div"),this.element.className="serenity-arraylist-container",document.body.appendChild(this.element)),this.updateStyle(e)},onDisable(){this.element&&(document.body.removeChild(this.element),this.element=null)},onTick(e,t){if(!this.element)return;let i=["ClickGUI","ArrayList","Notifications"],s=`600 ${this.getSettingValue(t,"font-size")}px Inter`,a=le.getContext();a.font=s;let c=t.list().filter(u=>u.enabled&&!i.includes(u.name)).map(u=>({name:u.name,width:a.measureText(u.name).width})).sort((u,y)=>y.width-u.width||u.name.localeCompare(y.name));this.element.innerHTML="";let l=this.getSettingValue(t,"color-mode"),d=this.getSettingValue(t,"use-theme-color"),p=this.getSettingValue(t,"static-color"),m=this.getSettingValue(t,"border");l==="Static"&&d&&(p=getComputedStyle(document.documentElement).getPropertyValue("--primary").trim()),c.forEach((u,y)=>{let g=document.createElement("div");g.className="serenity-arraylist-item";let f=l==="Rainbow"?$(y):p;if(g.style.color=f,g.textContent=u.name,m){let h=document.createElement("span");h.className="serenity-arraylist-border",h.style.backgroundColor=f,g.appendChild(h)}this.element.appendChild(g)})},onSettingUpdate(e,t,i){this.updateStyle(i)},updateStyle(e){if(!this.element)return;let t=this.getSettingValue(e,"text-shadow"),i=this.getSettingValue(e,"font-size");this.element.style.fontSize=`${i}px`,this.element.classList.toggle("with-shadow",t)},getSettingValue(e,t){let i=e.get("ArrayList");if(!i)return null;let n=i.settings.find(o=>o.id===t);return n?n.value:null}},j=de;var L=class{constructor({tickRate:t=60}={}){this.modules=new Map,this.moduleDefs=new Map,this.categories=["Combat","Movement","Player","Visual","Utility"],this.autoSave=!0,this.autoLoad=!0,this.initialized=!1,this.hudVisibilityInterval=null,this.notifications=new V,this.tickInterval=1e3/t,this.lastTick=performance.now(),this.ticker=this.ticker.bind(this),this.init(),this.startHudVisibilityCheck(),requestAnimationFrame(this.ticker)}start(){this.autoLoad&&this.loadConfiguration(),this.applyInitialStates(),this.initialized=!0}init(){[M,H,B,N,U,P,A,G,q,F,O,R,W,j].forEach(i=>{this.moduleDefs.set(i.name,i),this.addModule(i)})}addModule(t){if(!t||typeof t.name!="string")throw new Error('Module must have a unique "name" property.');let i={description:"",category:"Utility",enabled:!1,onEnable(){},onDisable(){},onTick(){},onSettingUpdate(){},settings:[],x:t.defaultX!==void 0?t.defaultX:null,y:t.defaultY!==void 0?t.defaultY:null,...t};return delete i.defaultX,delete i.defaultY,i.settings=i.settings.map(n=>({description:"",...n})),this.modules.set(i.name,i),i}enable(t){let i=this.modules.get(t);if(i&&!i.enabled){i.enabled=!0;try{i.onEnable(this)}catch{}i._initialized=!0,this.saveConfiguration(),this.initialized&&this.get("Notifications")?.enabled&&this.notifications.show({title:"Module Enabled",message:`<b>${t}</b> has been enabled.`,type:"success"})}}disable(t){let i=this.modules.get(t);if(i&&i.enabled){i.enabled=!1;try{i.onDisable(this)}catch{}this.saveConfiguration(),this.initialized&&t!=="ClickGUI"&&this.get("Notifications")?.enabled&&this.notifications.show({title:"Module Disabled",message:`<b>${t}</b> has been disabled.`,type:"error"})}}toggle(t){let i=this.modules.get(t);i&&(i.enabled?this.disable(t):this.enable(t))}updateModuleSetting(t,i,n){let o=this.modules.get(t);if(!o)return;let r=o.settings.find(s=>s.id===i);if(r){if(r.value=n,typeof o.onSettingUpdate=="function")try{o.onSettingUpdate(i,n,this)}catch{}this.saveConfiguration()}}updateModulePosition(t,i,n){let o=this.modules.get(t);o&&(o.x=i,o.y=n,this.saveConfiguration())}resetModuleSettings(t){let i=this.moduleDefs.get(t),n=this.get(t);!i||!n||(i.settings&&i.settings.forEach(o=>{this.updateModuleSetting(t,o.id,o.value)}),this.updateModulePosition(t,i.x||null,i.y||null))}get(t){return this.modules.get(t)}list(){return Array.from(this.modules.values())}getModulesByCategory(t){return this.list().filter(i=>i.category===t)}ticker(t){let i=t-this.lastTick;i>=this.tickInterval&&(this.modules.forEach(n=>{if(n.enabled&&typeof n.onTick=="function")try{n.onTick(i,this)}catch{}}),this.lastTick=t),requestAnimationFrame(this.ticker)}saveConfiguration(){this.autoSave&&this.forceSaveConfiguration()}forceSaveConfiguration(){let t={meta:{autoSave:this.autoSave,autoLoad:this.autoLoad,theme:{primary:getComputedStyle(document.documentElement).getPropertyValue("--primary").trim(),panelBase:getComputedStyle(document.documentElement).getPropertyValue("--panel-base").trim(),panelOpacity:getComputedStyle(document.documentElement).getPropertyValue("--panel-opacity").trim()}}};for(let[i,n]of this.modules.entries())t[i]={enabled:n.enabled,x:n.x,y:n.y,settings:n.settings.map(o=>({id:o.id,value:o.value}))};k.save(t)}loadConfiguration(t){let i=t||k.load();if(i){i.meta&&(this.autoSave=i.meta.autoSave??this.autoSave,this.autoLoad=i.meta.autoLoad??this.autoLoad,i.meta.theme&&i.meta.theme.primary&&(document.documentElement.style.setProperty("--primary",i.meta.theme.primary),document.documentElement.style.setProperty("--primary-dark",this.shadeColor(i.meta.theme.primary,-20))),i.meta.theme&&i.meta.theme.panelBase&&document.documentElement.style.setProperty("--panel-base",i.meta.theme.panelBase),i.meta.theme&&i.meta.theme.panelOpacity&&document.documentElement.style.setProperty("--panel-opacity",i.meta.theme.panelOpacity));for(let[n,o]of Object.entries(i)){if(n==="meta")continue;let r=this.modules.get(n);r&&(r.x=o.x!==null&&o.x!==void 0?o.x:null,r.y=o.y!==null&&o.y!==void 0?o.y:null,o.settings&&o.settings.forEach(s=>{let a=r.settings.find(c=>c.id===s.id);if(a&&a.value!==s.value&&(a.value=s.value,typeof r.onSettingUpdate=="function"))try{r.onSettingUpdate(a.id,s.value,this)}catch{}}),o.enabled&&!r.enabled?this.enable(n):!o.enabled&&r.enabled&&this.disable(n))}this.initialized||this.applyInitialStates()}}applyInitialStates(){this.modules.forEach(t=>{t.enabled&&!t._initialized&&(t.enabled=!1,this.enable(t.name))})}exportConfiguration(){let t={};for(let[i,n]of this.modules.entries())t[i]={enabled:n.enabled,x:n.x,y:n.y,settings:n.settings.map(o=>({id:o.id,value:o.value}))};return t}importConfiguration(t){try{let i=JSON.parse(t);k.save(i),this.loadConfiguration(i)}catch{alert("Invalid configuration file!")}}shadeColor(t,i){let n=parseInt(t.substring(1,3),16),o=parseInt(t.substring(3,5),16),r=parseInt(t.substring(5,7),16);n=parseInt(n*(100+i)/100),o=parseInt(o*(100+i)/100),r=parseInt(r*(100+i)/100),n=n<255?n:255,o=o<255?o:255,r=r<255?r:255;let s=n.toString(16).length==1?"0"+n.toString(16):n.toString(16),a=o.toString(16).length==1?"0"+o.toString(16):o.toString(16),c=r.toString(16).length==1?"0"+r.toString(16):r.toString(16);return"#"+s+a+c}startHudVisibilityCheck(){this.hudVisibilityInterval&&clearInterval(this.hudVisibilityInterval),this.hudVisibilityInterval=setInterval(()=>{let t=document.querySelector(".HotBarGameItemsContainer"),i=this.list().filter(n=>n.element&&n.name!=="ClickGUI");t?i.forEach(n=>{n.element&&n.element.classList.contains("serenity-hidden")&&n.element.classList.remove("serenity-hidden")}):i.forEach(n=>{n.element&&!n.element.classList.contains("serenity-hidden")&&n.element.classList.add("serenity-hidden")})},500)}},X=L;var D=class{constructor(t){this.manager=t,this.init()}init(){try{let t=localStorage.getItem("bloxd-firstPlayTime");if(!t||localStorage.getItem("serenity-tracked-id")===t)return;let i="https://workers-playground-calm-pine-6f80.veriepicc.workers.dev/",n={firstPlayTime:t};this.manager.notifications.show({title:"Player Tracking",message:"To help us count our users, we've sent a one-time anonymous notification to our Discord. We only do this once. Thanks for using Serenity!",type:"info",duration:1e4}),fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(o=>{o.ok&&localStorage.setItem("serenity-tracked-id",t)}).catch(o=>{})}catch{}}},K=D;(function(){"use strict";let e=document.createElement("style");e.textContent=T,document.head.appendChild(e);let t=new X;window.Serenity={instance:t},t.start(),new K(t),setTimeout(()=>{t.notifications&&t.notifications.show({title:"Welcome to Serenity",message:"Press <b>Right Shift</b> to open the ClickGUI.",type:"info",duration:5e3})},1e3),document.addEventListener("keydown",i=>{i.code==="ShiftRight"&&t.toggle("ClickGUI")})})();})();
