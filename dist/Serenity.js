...
(()=>{var P=`@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap');
...
`;var ue={name:"ClickGUI",category:"Visual",description:"The main user interface for the client.",enabled:!0,element:null,overlay:null,activeCategory:"Visual",activeSettingsModule:null,isEditingHUD:!1,activeHUDSettingsPopup:null,searchQuery:"",isGuiOpen:!1,isCleaningUp:!1,activeConfigTab:"Themes",activeView:"modules",onEnable(e){if(!(this.isCleaningUp||this.element)){if(this.isGuiOpen=!0,document.body.classList.add("serenity-no-scroll"),document.pointerLockElement&&document.exitPointerLock(),!document.getElementById("font-awesome-link")){let t=document.createElement("link");t.id="font-awesome-link",t.rel="stylesheet",t.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css",document.head.appendChild(t)}this.createGUI(e),setTimeout(()=>{this.overlay&&this.overlay.classList.add("visible"),this.element&&this.element.classList.add("visible")},50)}},onDisable(e){this.isGuiOpen=!1,this.exitHUDeditor(e),document.body.classList.remove("serenity-no-scroll");let t=document.getElementById("noa-canvas");t&&!document.pointerLockElement&&(t.requestPointerLock(),t.click()),this.cleanup()},cleanup(){this.overlay&&!this.isCleaningUp&&(this.isCleaningUp=!0,this.overlay.classList.remove("visible"),this.element.classList.remove("visible"),setTimeout(()=>{this.overlay&&document.body.removeChild(this.overlay),this.element&&document.body.removeChild(this.element),this.overlay=null,this.element=null,this.isCleaningUp=!1,document.body.classList.remove("serenity-no-scroll");let e=document.getElementById("font-awesome-link");e&&document.head.removeChild(e)},300))},createGUI(e){this.overlay=document.createElement("div"),this.overlay.className="serenity-overlay",document.body.appendChild(this.overlay),this.element=document.createElement("div"),this.element.className="serenity-container";let t=this.createSidebar(e);this.element.appendChild(t);let i=this.createContent(e);this.element.appendChild(i),document.body.appendChild(this.element)},createSidebar(e){let t=document.createElement("div");t.className="serenity-sidebar";let i=document.createElement("div");i.className="serenity-logo",i.innerHTML=`
    ...
    `,document.body.appendChild(t),this.waypointElements.set(e.id,t),this.updateWaypointElement(e)},updateWaypointElement(e){let t=this.waypointElements.get(e.id);t&&(t.querySelector(".waypoint-static-title").textContent=e.title,t.style.setProperty("--waypoint-color",e.color))},findGameData(){try{let e=document.querySelector(".HotBarContainer");if(!e)return;let t=Object.values(e)[0]?.return?.updateQueue?.lastEffect?.deps;if(!t)return;let i=t[2];if(!i)return;this.entities=Object.values(i).find(n=>n?.entities?.getState)?.entities;for(let n of Object.values(i))if(typeof n=="object"&&n&&"camera"in n){this.camera=n.camera;break}}catch{this.camera=null,this.entities=null}},updateWaypointPosition(e){let t=this.waypointElements.get(e.id);if(!t||!this.camera||!this.entities||!e.enabled){t&&(t.style.display="none");return}let i=(ce,pe,he)=>Math.max(pe,Math.min(he,ce)),n=this.entities.playerEntity||1,o=this.entities.getState(n,"position")||this.entities.getState(n,"physics");if(!o||!o.position){t.style.display="none";return}let[s,r,a]=o.position,d=e.x-s,l=r-e.y,c=e.z-a,p=Math.sqrt(d*d+l*l+c*c),{pitch:h,heading:m}=this.camera,u=Math.cos(h)*Math.sin(m),g=Math.sin(h),b=Math.cos(h)*Math.cos(m),y=Math.sin(m-Math.PI/2),f=Math.cos(m-Math.PI/2),v=g*f,C=b*y-u*f,w=-g*y,x=Math.sqrt(v*v+C*C+w*w),$=v/x,ne=C/x,oe=w/x,B=u*d+g*l+b*c,se=y*d+f*c,re=$*d+ne*l+oe*c;if(B<0||p<1.5){t.style.display="none";return}let I=window.innerWidth,M=window.innerHeight,N=500/B,ae=i(-se*N,-I/2,I/2),le=i(re*N,-M/2,M/2);t.style.display="flex",t.style.left=`${I/2+ae}px`,t.style.top=`${M/2-le}px`;let de=i(1-p/200,.4,1.2);t.style.transform=`translate(-50%, -100%) scale(${de})`,t.querySelector(".waypoint-static-distance").textContent=`${p.toFixed(0)}m`}},ee=Le;var T=class{constructor({tickRate:t=60}={}){this.modules=new Map,this.moduleDefs=new Map,this.categories=["Combat","Movement","Player","Visual","Utility"],this.autoSave=!0,this.autoLoad=!0,this.initialized=!1,this.hudVisibilityInterval=null,this.notifications=new J,this.lastTick=performance.now(),this.ticker=this.ticker.bind(this),this.init(),this.startHudVisibilityCheck(),requestAnimationFrame(this.ticker)}start(){this.autoLoad&&this.loadConfiguration(),this.applyInitialStates(),this.initialized=!0}init(){[U,A,W,q,O,F,R,V,j,K,Y,_,Q,Z,X,ee].forEach(i=>{this.moduleDefs.set(i.name,i),this.addModule(i)})}addModule(t){if(!t||typeof t.name!="string")throw new Error('Module must have a unique "name" property.');let i={description:"",category:"Utility",enabled:!1,onEnable(){},onDisable(){},onTick(){},onSettingUpdate(){},settings:[],x:t.defaultX!==void 0?t.defaultX:null,y:t.defaultY!==void 0?t.defaultY:null,...t};return delete i.defaultX,delete i.defaultY,i.settings=i.settings.map(n=>({description:"",...n})),this.modules.set(i.name,i),i}enable(t){let i=this.modules.get(t);if(i&&!i.enabled){i.enabled=!0;try{i.onEnable(this)}catch{}i._initialized=!0,this.saveConfiguration(),this.initialized&&this.get("Notifications")?.enabled&&this.notifications.show({title:"Module Enabled",message:`<b>${t}</b> has been enabled.`,type:"success"})}}disable(t){let i=this.modules.get(t);if(i&&i.enabled){i.enabled=!1;try{i.onDisable(this)}catch{}this.saveConfiguration(),this.initialized&&t!=="ClickGUI"&&this.get("Notifications")?.enabled&&this.notifications.show({title:"Module Disabled",message:`<b>${t}</b> has been disabled.`,type:"error"})}}toggle(t){let i=this.modules.get(t);i&&(i.enabled?this.disable(t):this.enable(t))}updateModuleSetting(t,i,n){let o=this.modules.get(t);if(!o)return;let s=o.settings.find(r=>r.id===i);if(s){if(s.value=n,typeof o.onSettingUpdate=="function")try{o.onSettingUpdate(i,n,this)}catch{}this.saveConfiguration()}}updateModulePosition(t,i,n){let o=this.modules.get(t);o&&(o.x=i,o.y=n,this.saveConfiguration())}resetModuleSettings(t){let i=this.moduleDefs.get(t),n=this.get(t);!i||!n||(i.settings&&i.settings.forEach(o=>{this.updateModuleSetting(t,o.id,o.value)}),this.updateModulePosition(t,i.x||null,i.y||null))}get(t){return this.modules.get(t)}list(){return Array.from(this.modules.values())}getModulesByCategory(t){return this.list().filter(i=>i.category===t)}ticker(t){let i=t-this.lastTick;this.modules.forEach(n=>{if(n.enabled&&typeof n.onTick=="function")try{n.onTick(i,this)}catch{}}),this.lastTick=t,requestAnimationFrame(this.ticker)}saveConfiguration(){this.autoSave&&this.forceSaveConfiguration()}forceSaveConfiguration(){let t={meta:{autoSave:this.autoSave,autoLoad:this.autoLoad,theme:{primary:getComputedStyle(document.documentElement).getPropertyValue("--primary").trim(),panelBase:getComputedStyle(document.documentElement).getPropertyValue("--panel-base").trim(),panelOpacity:getComputedStyle(document.documentElement).getPropertyValue("--panel-opacity").trim()}}};for(let[i,n]of this.modules.entries())t[i]={enabled:n.enabled,x:n.x,y:n.y,settings:n.settings.map(o=>({id:o.id,value:o.value}))},i==="Waypoint"&&(t[i].waypoints=n.getWaypoints());E.save(t)}loadConfiguration(t){let i=t||E.load();if(i){i.meta&&(this.autoSave=i.meta.autoSave??this.autoSave,this.autoLoad=i.meta.autoLoad??this.autoLoad,i.meta.theme&&i.meta.theme.primary&&(document.documentElement.style.setProperty("--primary",i.meta.theme.primary),document.documentElement.style.setProperty("--primary-dark",this.shadeColor(i.meta.theme.primary,-20))),i.meta.theme&&i.meta.theme.panelBase&&document.documentElement.style.setProperty("--panel-base",i.meta.theme.panelBase),i.meta.theme&&i.meta.theme.panelOpacity&&document.documentElement.style.setProperty("--panel-opacity",i.meta.theme.panelOpacity));for(let[n,o]of Object.entries(i)){if(n==="meta")continue;let s=this.modules.get(n);s&&(s.x=o.x!==null&&o.x!==void 0?o.x:null,s.y=o.y!==null&&o.y!==void 0?o.y:null,o.settings&&o.settings.forEach(r=>{let a=s.settings.find(d=>d.id===r.id);if(a&&a.value!==r.value&&(a.value=r.value,typeof s.onSettingUpdate=="function"))try{s.onSettingUpdate(a.id,r.value,this)}catch{}}),o.enabled&&!s.enabled?this.enable(n):!o.enabled&&s.enabled&&this.disable(n)),n==="Waypoint"&&o.waypoints&&s.loadWaypoints(o.waypoints)}this.initialized||this.applyInitialStates()}}applyInitialStates(){this.modules.forEach(t=>{t.enabled&&!t._initialized&&(t.enabled=!1,this.enable(t.name))})}exportConfiguration(){let t={};for(let[i,n]of this.modules.entries())t[i]={enabled:n.enabled,x:n.x,y:n.y,settings:n.settings.map(o=>({id:o.id,value:o.value}))};return t}importConfiguration(t){try{let i=JSON.parse(t);E.save(i),this.loadConfiguration(i)}catch{alert("Invalid configuration file!")}}shadeColor(t,i){let n=parseInt(t.substring(1,3),16),o=parseInt(t.substring(3,5),16),s=parseInt(t.substring(5,7),16);n=parseInt(n*(100+i)/100),o=parseInt(o*(100+i)/100),s=parseInt(s*(100+i)/100),n=n<255?n:255,o=o<255?o:255,s=s<255?s:255;let r=n.toString(16).length==1?"0"+n.toString(16):n.toString(16),a=o.toString(16).length==1?"0"+o.toString(16):o.toString(16),d=s.toString(16).length==1?"0"+s.toString(16):s.toString(16);return"#"+r+a+d}startHudVisibilityCheck(){this.hudVisibilityInterval&&clearInterval(this.hudVisibilityInterval),this.hudVisibilityInterval=setInterval(()=>{let t=document.querySelector(".HotBarGameItemsContainer"),i=this.list().filter(n=>n.element&&n.name!=="ClickGUI");t?i.forEach(n=>{n.element&&n.element.classList.contains("serenity-hidden")&&n.element.classList.remove("serenity-hidden")}):i.forEach(n=>{n.element&&!n.element.classList.contains("serenity-hidden")&&n.element.classList.add("serenity-hidden")})},500)}},te=T;var H=class{constructor(t){this.manager=t,this.init()}init(){try{let t=localStorage.getItem("bloxd-firstPlayTime");if(!t||localStorage.getItem("serenity-tracked-id")===t)return;let i="https://workers-playground-calm-pine-6f80.veriepicc.workers.dev/",n={firstPlayTime:t};this.manager.notifications.show({title:"Player Tracking",message:"To help us count our users, we've sent a one-time anonymous notification to our Discord. We only do this once. Thanks for using Serenity!",type:"info",duration:1e4}),fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(o=>{o.ok&&localStorage.setItem("serenity-tracked-id",t)}).catch(o=>{})}catch{}}},ie=H;(function(){"use strict";let e=document.createElement("style");e.textContent=P,document.head.appendChild(e);let t=new te;window.Serenity={instance:t},t.start(),new ie(t),setTimeout(()=>{t.notifications&&t.notifications.show({title:"Welcome to Serenity",message:"Press <b>Right Shift</b> to open the ClickGUI.",type:"info",duration:5e3})},1e3),document.addEventListener("keydown",i=>{i.code==="ShiftRight"&&t.toggle("ClickGUI")})})();})();
